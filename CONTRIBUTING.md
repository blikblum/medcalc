## Contributing to medcalc

♥ [medcalc](https://github.com/blikblum/medcalc) and want to get involved? Thanks!
...
The [issue tracker](https://github.com/blikblum/medcalc/issues) is the preferred channel
for [bug reports](#bugs), [features requests](#features) and [submitting pull requests](#pull-requests),
but please respect the following restrictions:

* Please **do not** use the issue tracker for personal support requests.
  [Stack Overflow](https://stackoverflow.com/questions/tagged/medcalc) is a better place to get help.
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git clone https://github.com/blikblum/medcalc.git
   # Navigate to the newly cloned directory
   cd medcalc
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/blikblum/medcalc.git
   ```
